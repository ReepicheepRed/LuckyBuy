...
public class PayPalActivity extends Activity {
    ...
    //myself
//    private static final String CONFIG_CLIENT_ID = "AZyKdf33fZDJ5yh0SzoK_25lycv5rXDwOyhdYop14m9nfTFXrFi575MV8_Cel4lWHXsRIx1Uky7GkMUc";
    //company
//    private static final String CONFIG_CLIENT_ID = "AcPULdLigZ3rVTaib6xifn4depRzmZ0ydRehVkpI50sCOGYcYW5enfjkM5YiC0MvMx4quCIUny1G1Gg5";

    //泰国正式
    private static final String CONFIG_CLIENT_ID ="AZ-3Vdfk1fMngFqG8bqqzE1AmoOAmEUsHXueEkP4nlwp1-GYYQge5nWgD27oUTJRNrZvBQ0gNHsXyP5s";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startService(intent);
        //onBuyPressed(View pressed);

        orderInfo = getIntent();
        bundle = orderInfo.getExtras();
        isPayment = orderInfo.getBooleanExtra("isPayment",false);
        onBuyPressed();
    }
    private Bundle bundle = new Bundle();
    private Intent orderInfo;
    ...
    private PayPalPayment getThingToBuy(String paymentIntent) {
        ...
        //return new PayPalPayment(new BigDecimal("0.01"), "THB", order_number, paymentIntent);
        return new PayPalPayment(new BigDecimal(amount), "THB", order_number, paymentIntent);
        //return new PayPalPayment(new BigDecimal(amount), "USD", order_number, paymentIntent);
    }
