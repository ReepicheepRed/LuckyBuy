...
public class Home_Awards_Latest_Fragment extends BaseFragment implements AdapterView.OnItemClickListener{
    ...
    private void initView(){
        ...
        String REQUEST_TYPE = "fresh",REQUEST_COUNT = "10",LAST_ID = "0";
