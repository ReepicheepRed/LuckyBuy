 ...
 */
public class F_SNS_BaskAdapter extends ListBaseAdapter<UnveilAwardModel>{

    private Holder holder;
    private LayoutInflater mInflater;
    private ImageOptions imageOptions;
    public F_SNS_BaskAdapter(Context context, List<UnveilAwardModel> list) {
        super(context, list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String issueStr = holder.issue.getText().toString();
        holder.issue.setText(issueStr.substring(0,3) + unveilModel.getTimeid()+"");
